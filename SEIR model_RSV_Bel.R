...
# ggplot(case_dt, aes(week, cases.less1yrs))+
#   geom_point()
...
# score for initial model
get_sum_of_squares(out$I1[1:length(case_dt$cases)]*pop_size,case_dt$cases.less1yrs)
...
get_parameter_score <- function(x) {
  ...
  # get model score
  model_score <- get_sum_of_squares(model_out$I1[length(case_dt$cases)]*pop_size,case_dt$cases.less1yrs)
...
plot_model_fit <- function(x){
  ...
  # get model score
  model_score <- get_sum_of_squares(model_out$I1[1:length(case_dt$cases)]*pop_size,case_dt$cases.less1yrs)

  # plot reference data
  plot(case_dt$week,
       case_dt$cases.less1yrs,
       ylim = c(0,max(case_dt$cases.less1yrs)*2),
...
case_dt$week <- seq(1,dim(case_dt)[1])
case_dt$cases.less1yrs <- round(case_dt$cases*pro_case_less1yrs)
## score for initial model
# ggplot(case_dt, aes(week, cases.less1yrs))+
#   geom_point()
...
plot(case_dt$week,
     ...
     ylim = c(0, max(case_dt$cases.less1yrs)*1.5))
